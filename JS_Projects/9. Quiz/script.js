...
function startGame() {
  ...
  // questions 배열에 아이템 순서를 랜덤으로 만들기
...
function showQuestion(question) {
  ...
  // questionEl HTML 요소에 quewtions배열내 객체 question의 question을 넣겠다
  ...
  question.answers.forEach((answer) => {
    ...
    if(answer.correct) {
      // 정답인 버튼 요소의 속성으로 data-correct="true"로 넣어줌
...
function setStatusClass(element, correct) {
  ...
  // 정답이면 elemnet class 속성에 correct, 아니면 wrong
  if(correct) {
